...
sub_model = siamese_model.get_layer('model_14')
dense_layers = [layer for layer in sub_model.layers if type(layer) is Dense]
embedding_model = Model(inputs=sub_model.input, outputs=dense_layers[-1].output)
